...
function init() {
    ...
    // Generate the cube
    generateCube(gl, programInfo);
}


// Calls all the functions related to generating the cube
function generateCube(gl, programInfo) {

    // Initialize buffers
    const buffers = cubeBuffers(gl);
...
// Returns the buffers for generating the cube with textures
